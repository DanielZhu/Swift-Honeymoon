...
let myString = "s"
let possibleInt = Int(myString)
print(possibleInt)

var petList = ["DD", "CC", "Maoqiu"]
petList[0]
petList[1] = "LL"
petList
...
greet(name: "Dan", day: "Monday")
greet(name: "Anna", day: "Wed")
greet(name: "Cici", day: "Friday")
...
array.insert("cherry", at: 1)
array.index(of: "banana")
array.count
...
let namedShape = NamedShape(name: "demo shape")
...
enum Rank: Int {
    ...
    func simpleDescription() -> String {
        ...
        case .King:
            return "king"
        default:
            return String(describing: self) + " over"
        }
    }
}
let ace = Rank.Ace
